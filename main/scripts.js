...
function search_site() {
    ...
    if (input.includes("abnormal")) {
        ...
        result.innerHTML = spacer + '<ul><li> <a href="https://oscybershop.herokuapp.com/main/pages/red.html#awesome-browser_exploit" target="_blank">Offensive Cyber (Red Team) - &quot;Awesome-Browser Exploit&quot;</a> </li></ul>' + spacer + '<ul><li> <a href="https://oscybershop.herokuapp.com/main/pages/blue.html#awesome_ctf" target="_blank">Awesome CTF</a> </li></ul>' + spacer + '<ul><li> <a href="https://oscybershop.herokuapp.com/main/pages/blue.html#awesome_ir" target="_blank">Awesome IR</a> </li></ul>' + spacer + '<ul><li> <a href="https://oscybershop.herokuapp.com/main/pages/blue.html#awesome_awesomeness" target="_blank">Awesome Awesomeness</a> </li></ul>' + spacer + '<ul><li> <a href="https://oscybershop.herokuapp.com/main/pages/blue.html#awesome_event_ids" target="_blank">Awesome Event IDs</a></ul>';
    }
