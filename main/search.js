...
function search_site() {
    ...
    if (input.includes("abnormal")) {
        ...
        result.innerHTML = 'Cheat Sheets<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/cheatsheets.html#event_log_analysis" target="_blank">Event Log Analysis</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/cheatsheets.html#lateral_movement_analysis" target="_blank">Lateral Movement Analysis</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/cheatsheets.html#web_proxy_event_analysis" target="_blank">Web Proxy Event Analysis</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/cheatsheets.html#malware_analysis" target="_blank">Malware Analysis</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/cheatsheets.html#anti_virus_event_analysis" target="_blank">Anti Virus Event Analysis</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/cheatsheets.html#remnux" target="_blank">REMnux</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/cheatsheets.html#reverse_engineering" target="_blank">Reverse Engineering</a></li></ul><br>Publications<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/publications.html#pmat_labs_walkthroughs" target="_blank">PMAT Labs Walkthroughs</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/publications.html#linux_forensics_binary_analysis" target="_blank">Linux Forensics Binary Analysis</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/publications.html#analysis_of_golang_malware" target="_blank">Analysis of GoLang Malware</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/publications.html#blue_team-system_live_analysis" target="_blank">Blue Team-System Live Analysis</a></li></ul>';
    }
        ...
        result.innerHTML = 'Publications<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/publications.html#atomic_red_team_hands-on" target="_blank">Atomic Red Team: Hands-On</a></li></ul><br>Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#atomic_red_team_hands-on" target="_blank">Atomic Red Team: Hands-On</a></li></ul><br>Frameworks &amp; Projects<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/projects.html#atomic_red_team" target="_blank">Atomic Red Team</a></li></ul>';
    }
        ...
        result.innerHTML = 'Publications<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/publications.html#linux_forensics_binary_analysis" target="_blank">Linux Forensics Binary Analysis</a></li></ul><br>Cyber Defence (Blue Team)<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/blue.html#binary_ninja" target="_blank">Binary Ninja</a></li></ul>';
    }
        ...
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#bug_bounty_basics" target="_blank">Bug Bounty Basics</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#bug_hunters_methodology" target="_blank">Bug Hunters Methodology</a></li></ul><brTraining, CTFs &amp; Challenges<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/training.html#bugcrowd" target="_blank">Bugcrowd</a></li></ul><br>Virtual Machines<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/vms.html#bugtraq" target="_blank">Bugtraq</a></li></ul>';
    }
        ...
        result.innerHTML = 'Posters<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/posters.html#ciso_mind_map" target="_blank">CISO Mind Map</a></li></ul><br>Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#the_hacker_mind" target="_blank">The Hacker Mind</a></li></ul>';
    }
    else if (input.includes("ciso")) {
        result.innerHTML = 'Posters<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/posters.html#ciso_mind_map" target="_blank">CISO Mind Map</a></li></ul><br>Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#cyber_security_headlines_by_the_ciso_series" target="_blank">Cyber Security Headlines by the CISO Series</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#life_of_a_ciso" target="_blank">Life of a CISO</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#the_virtual_ciso_moment" target="_blank">The Virtual CISO Moment</a></li></ul>';
    }
    else if (input.includes("cli")) {
        result.innerHTML = 'Cheat Sheets<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/cheatsheets.html#windows-linux_cli" target="_blank">Windows Linux CLI</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/cheatsheets.html#linux_cli_fundamentals" target="_blank">Linux CLI Fundamentals</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/cheatsheets.html#linux_cli" target="_blank">Linux CLI</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/cheatsheets.html#windows_cli" target="_blank">Windows CLI</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/cheatsheets.html#multi_cloud_cli" target="_blank">Multi Cloud CLI</a></li></ul>';
    }
    else if (input.includes("cloud")) {
        result.innerHTML = 'Posters<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/posters.html#cloud_forensics" target="_blank">Cloud Forensics</a></li></ul><br>Cheat Sheets<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/cheatsheets.html#multi_cloud_cli" target="_blank">Multi Cloud CLI</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/cheatsheets.html#cloud_security_devops" target="_blank">Cloud Security DevOps</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/cheatsheets.html#aws" target="_blank"> AWS</a></li></ul><br>Tooling<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/tooling.html#aws_arsenal" target="_blank">AWS Arsenal</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/tooling.html#google_cloud_architecture_diagramming" target="_blank">Google Cloud Architecture Diagramming</a></li></ul><br>Cyber Defence (Blue Team)<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/blue.html#az_900_azure_fundamentals" target="_blank">AZ-900 Azure Fundamentals</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/blue.html#azurehunter" target="_blank">Azurehunter</a></li></ul><br>Cheat Sheets<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/cheatsheets.html#gcp" target="_blank">GCP</a></li></ul>';
    }
        ...
        result.innerHTML = 'Publications<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/publications.html#cyber_capabilities_and_national_power" target="_blank">Cyber Capabilities and National Power</a></li></ul><br>Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#how_cyberattacks_threaten_real_world" target="_blank">How Cyberattacks Threaten Real World</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#what_is_cybercrime?" target="_blank">What is Cybercrime?</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#everyday_cybercrime_and_what_you_can_do_about_it" target="_blank">Everyday Cybercrime and what you can do about it</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#defining_cyberwarfare" target="_blank">Defining Cyberwarfare</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#cyber_security_headlines_by_the_ciso_series" target="_blank">Cyber Security Headlines by the CISO Series</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#cyber_security_sauna" target="_blank">Cyber Security Sauna</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#cyber_work" target="_blank">Cyber Work</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#sans_internet_stormcenter_daily_cyber" target="_blank">SANS Internet Stormcenter Daily Cyber</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#task_force_7_cyber_security_radio" target="_blank">Task Force 7 Cyber Security Radio</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#the_cyber_tap_(cybertap)" target="_blank">The Cyber Tap (cyberTAP)</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#we_talk_cyber_(monica_talks_cyber)" target="_blank">We Talk Cyber (Monica Talks Cyber)</a></li></ul><br>Frameworks &amp; Projects<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/projects.html#cyberbattlesim" target="_blank">Cyberbattlesim</a></li></ul><br>Cyber Defence (Blue Team)<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/blue.html#cyberchef" target="_blank">Cyberchef</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/blue.html#cyberdefenders" target="_blank">Cyberdefenders</a></li></ul></ul><br>Offensive Cyber (Red Team)<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/red.html#atomic_red_team" target="_blank">Atomic Red Team</a></li></ul>';
    }
        ...
        result.innerHTML = 'Posters<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/posters.html#cloud_forensics" target="_blank">Cloud Forensics</a></li></ul><br>Cheat Sheets<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/cheatsheets.html#macOS_forensics" target="_blank">macOS Forensics</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/cheatsheets.html#memory_forensics" target="_blank">Memory Forensics</a></li></ul><br>Publications<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/publications.html#linux_forensics_binary_analysis" target="_blank">Linux Forensics Binary Analysis</a></li></ul><br>Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#investigating_malware_using_memory_forensics" target="_blank">Investigating Malware Using Memory Forensics</a></li></ul>';
    }
        ...
        result.innerHTML = 'Cheat Sheets<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/cheatsheets.html#google_hacking" target="_blank">Google Hacking</a></li></ul><br>Tooling<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/tooling.html#google_cloud_architecture_diagramming" target="_blank">Google Cloud Architecture Diagramming</a></li></ul><br>Cyber Defence (Blue Team)<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/blue.html#timesketch" target="_blank">Timesketch</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/blue.html#grr" target="_blank">grr</a></li></ul>';
    }
        ...
        result.innerHTML = 'Publications<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/publications.html#elite_hackers_of_the_fsb" target="_blank">Elite Hackers of the FSB</a></li></ul><br>Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#hackersploit" target="_blank">Hackersploit</a></li></ul>';
    }
    else if (input.includes("hacking")) {
        result.innerHTML = 'Cheat Sheets<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/cheatsheets.html#google_hacking" target="_blank">Google Hacking</a></li></ul><br>Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#hacking_humans" target="_blank">Hacking Humans</a></li></ul>';
    }
        ...
        result.innerHTML = 'Publications<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/publications.html#infosec_amateur" target="_blank">InfoSec Amateur</a></li></ul><br>Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#humans_of_infosec" target="_blank">Humans of InfoSec</a></li></ul><br>Threat Intelligence<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/int.html#infosec_osint_show" target="_blank">Infosec OSINT Show</a></li></ul>';
    }
        ...
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#how_we_take_back_the_internet" target="_blank">How we Take Back the Internet</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#sans_internet_stormcenter_daily_cyber" target="_blank">SANS Internet Stormcenter Daily Cyber</a></li></ul>';
    }
    else if (input.includes("investigat")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#investigating_wmi_attacks" target="_blank">Investigating WMI Attacks</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#investigating_malware_using_memory_forensics" target="_blank">Investigating Malware Using Memory Forensics</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#how_to_investigate_phishing_campaigns" target="_blank">How to Investigate Phishing Campaigns</a></li></ul><br>Threat Intelligence<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/int.html#soc_investigation" target="_blank">SOC Investigation</a></li></ul>';
    }
    else if (input.includes("wmi attacks")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#investigating_wmi_attacks" target="_blank">Investigating WMI Attacks</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#investigating_malware_using_memory_forensics" target="_blank">Investigating Malware Using Memory Forensics</a></li></ul>';
    }
        ...
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#joe_helle" target="_blank">Joe Helle</a></li></ul><br>Cyber Defence (Blue Team)<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/blue.html#joe_sandbox" target="_blank">Joe Sandbox</a></li></ul>';
    }
        ...
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#8th_layer_insights" target="_blank">8th Layer Insights</a></li></ul><br>Threat Intelligence<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/int.html#layer_8" target="_blank">Layer 8</a></li></ul>';
    }
    ...
    else if (input.includes("macos") || input.includes("mac")) {
        result.innerHTML = 'Cheat Sheets<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/cheatsheets.html#macOS_forensics" target="_blank">macOS Forensics</a></li></ul><br>Publications<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/publications.html#the_art_of_mac_malware" target="_blank">The Art of Mac Malware</a></li></ul>';
    }
    ...
    else if (input.includes("malicious documents")) {
        ...
        result.innerHTML = 'Cheat Sheets<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/cheatsheets.html#malicious_documents" target="_blank">Malicious Documents</a></li></ul><br>Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#malicious_life" target="_blank">Malicious Life</a></li></ul>';
    }
        ...
        result.innerHTML = 'Publications<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/publications.html#ten_strategies_of_a_world_class_csoc" target="_blank">Ten Strategies of a World-Class CSOC</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/publications.html#mitre_attack_mapping" target="_blank">MITRE ATT&CK Mapping</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/publications.html#using_mitre_attack_threat_hunting_detection" target="_blank">Using MITRE ATT&CK Threat Hunting Detection</a></li></ul><brTraining, CTFs &amp; Challenges<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/training.html#cybrary" target="_blank">Cybrary</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/training.html#mitre_enginuity" target="_blank">MITRE Enginuity</a></li></ul><br>Frameworks &amp; Projects<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/projects.html#attack_framework" target="_blank">ATT&CK Framework</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/projects.html#attack_navigator" target="_blank">ATT&CK Navigator</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/projects.html#d3fend" target="_blank">D3FEND</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/projects.html#engage" target="_blank">Engage</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/projects.html#caldera" target="_blank">Caldera</a></li></ul><br>Cyber Defence (Blue Team)<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/blue.html#attack_framework" target="_blank">ATT&CK Framework</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/blue.html#attack_navigator" target="_blank">ATT&CK Navigator</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/blue.html#d3fend" target="_blank">D3FEND</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/blue.html#engage" target="_blank">Engage</a></li></ul><br>Offensive Cyber (Red Team)<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/red.html#caldera" target="_blank">Caldera</a></li></ul>';
    }
    ...
    else if (input.includes("order") || input.includes("search order") || input.includes("search order hijacking") || input.includes("soh") || input.includes("identifying")) {
        ...
        result.innerHTML = 'Publications<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/publications.html#owasp_testing_guide" target="_blank">OWASP Testing Guide</a></li></ul><br>Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#owasp" target="_blank">OWASP</a></li></ul><br>Frameworks &amp; Projects<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/projects.html#owasp" target="_blank">OWASP</a></li></ul>';
    }
        ...
        result.innerHTML = 'Posters<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/posters.html#penetration_testing" target="_blank">Penetration Testing</a></li></ul><br>Publications<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/publications.html#python_red_team_pentest_threat_hunt" target="_blank">Python Red Team Pentest Threat Hunt</a></li></ul><br>Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#hackers_physical_pentest_toolkit" target="_blank">Hacker\'s Physical Pentest Toolkit</a></li></ul><brTraining, CTFs &amp; Challenges<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/training.html#pentesteracademy" target="_blank">Training, CTFs &amp; ChallengePentesteracademy</a></li></ul><br>Virtual Machines<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/vms.html#pentestbox" target="_blank">Pentestbox</a></li></ul><br>Offensive Cyber (Red Team)<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/red.html#sample_pen_test_report" target="_blank">Sample Pen Test Report</a></li></ul>';
    }
        ...
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#phishing" target="_blank">Phishing</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#how_to_investigate_phishing_campaigns" target="_blank">How to Investigate Phishing Campaigns</a></li></ul><br>Cyber Defence (Blue Team)<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/blue.html#phishingkittracker" target="_blank">PhishingKitTracker</a></li></ul>';
    }
    ...
    else if (input.includes("shell") || input.includes("powershell") || input.includes("power shell")) {
        ...
        result.innerHTML = 'Publications<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/publications.html#cyber_capabilities_and_national_power" target="_blank">Cyber Capabilities and National Power</a></li></ul><br>Cyber Defence (Blue Team)<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/blue.html#powershell_core" target="_blank">Powershell Core</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/blue.html#blue_team_powershell" target="_blank">Blue Team Powershell</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/blue.html#powerforensics" target="_blank">PowerForensics</a></li></ul><br>Offensive Cyber (Red Team)<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/red.html#empire" target="_blank">PowerShell Empire</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/red.html#powershell_wmic" target="_blank">PowerShell &amp; WMIC</a></li></ul>';
    }
        ...
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#privacy_advisor" target="_blank">Privacy Advisor</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#privacy" target="_blank">Privacy</a></li></ul><br>Threat Intelligence<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/int.html#privacytools" target="_blank">PrivacyTools</a></li></ul>';
    }
        ...
        result.innerHTML = 'Cheat Sheets<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/cheatsheets.html#reverse_engineering" target="_blank">Reverse Engineering</a></li></ul><br>Publications<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/publications.html#reverse_engineering_wannacry" target="_blank">Reverse Engineering Wannacry</a></li></ul>';
    }
        ...
        result.innerHTML = 'Posters<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/posters.html#secure_devops" target="_blank">Secure Devops</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/posters.html#secure_web_app_testing" target="_blank">Secure Web App Testing</a></li></ul><br>Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#the_secure_developer" target="_blank">The Secure Developer</a></li></ul><br>Training, CTFs & Challenges<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/training.html#certified_secure" target="_blank">Certified Secure</a></li></ul>';
    }
    else if (input.includes("security")) {
        result.innerHTML = 'Posters<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/posters.html#securityzines" target="_blank">Securityzines</a></li></ul><br>Cheat Sheets<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/cheatsheets.html#cloud_security_devops" target="_blank">Cloud Security Devops</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/cheatsheets.html#security_architecture" target="_blank">Security Architecture</a></li></ul><br>Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#brakeing_down_security" target="_blank">Brakeing Down Security</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#defensive_security" target="_blank">Defensive Security</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#ubuntu_security" target="_blank">Ubuntu Security</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#open_source_security" target="_blank">Open Source Security</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#crypto-gram_security" target="_blank">Crypto-Gram Security</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#cyber_security_headlines_by_the_ciso_series" target="_blank">Cyber Security Headlines by the CISO Series</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#cyber_security_sauna" target="_blank">Cyber Security Sauna</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#naked_security" target="_blank">Naked Security</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#purple_squad_security" target="_blank">Purple Squad Security</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#security_in_five" target="_blank">Security in Five</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#security_now" target="_blank">Security Now</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#security_weekly" target="_blank">Security Weekly</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#smashing_security" target="_blank">Smashing Security</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#task_force_7_cyber_security_radio" target="_blank">Task Force 7 Cyber Security Radio</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#the_443_security_simplified" target="_blank">The 443 Security Simplified</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#the_shared_security_show" target="_blank">The Shared Security Show</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#7_minute_security" target="_blank">7 Minute Security</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#offensive_security" target="_blank">Offensive Security</a></li></ul><br>Tooling<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/tooling.html#ssa_security_awareness_planning_kit" target="_blank">SSA Security Awareness Planning Kit</a></li></ul><br>Training, CTFs & Challenges<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/training.html#portswigger_web_security_academy" target="_blank">PortSwigger Web Security Academy</a></li></ul>';
    }
        ...
        result.innerHTML = 'Publications<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/publications.html#powershell_light_side_of_the_force" target="_blank">Powershell Light Side of the Force</a></li></ul><br>Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#task_force_7_cyber_security_radio" target="_blank">Task Force 7 Cyber Security Radio</a></li></ul><br>Threat Intelligence<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/int.html#rangeforce" target="_blank">Rangeforce</a></li></ul>';
    }
        ...
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#hacker_valley_studio" target="_blank">Hacker Valley Studio</a></li></ul><br>Cyber Defence (Blue Team)<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/blue.html#pestudio" target="_blank">pestudio</a></li></ul>';
    }
        ...
        result.innerHTML = 'Training, CTFs & Challenges<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/training.html#cyberseclabs" target="_blank">CyberSecLabs</a></li></ul><br>Threat Intelligence<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/int.html#trace_labs" target="_blank">Trace Labs</a></li></ul>';
    }
        ...
        result.innerHTML = 'Cheat Sheets<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/cheatsheets.html#volatility" target="_blank">Volatility</a></li></ul><br>Cyber Defence (Blue Team)<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/blue.html#volatility" target="_blank">Volatility</a></li></ul>';
    }
    else if (input.includes("vscode")) {
        result.innerHTML = 'Cheat Sheets<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/cheatsheets.html#vscode_macos_keyboard_shortcuts" target="_blank">VScode macOS Keyboard Shortcuts</a></li></ul><br>Threat Intelligence<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/int.html#vscode" target="_blank">vscode</a></li></ul>';
    }
        ...
        result.innerHTML = 'Cheat Sheets<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/cheatsheets.html#windows-linux_cli" target="_blank">Windows & Linux CLI</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/cheatsheets.html#windows_cli" target="_blank">Windows CLI</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/cheatsheets.html#powershell_wmic" target="_blank">PowerShell & WMIC</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/cheatsheets.html#ids" target="_blank">Intrusion Detection</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/cheatsheets.html#dfir" target="_blank">DFIR & Threat Hunting</a></li></ul><br>Cyber Defence (Blue Team)<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/blue.html#windows_forensics" target="_blank">Windows Forensics</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/blue.html#windows_third_party_apps" target="_blank">Windows Third Party Apps</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/blue.html#windows_cred_attacks_mitigations" target="_blank">Windows Cred. Attacks Mitigations</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/blue.html#winpmem" target="_blank">Winpmem</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/blue.html#windbg" target="_blank">Windbg</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/blue.html#windows_cli" target="_blank">Windows CLI</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/blue.html#windows-linux_cli" target="_blank">Windows Linux CLI</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/blue.html#windows_processes" target="_blank">Windows Processes</a></li></ul>';
    }
        ...
        result.innerHTML = 'Cheat Sheets<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/cheatsheets.html#windows-linux_cli" target="_blank">Windows Linux CLI</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/cheatsheets.html#windows_cli" target="_blank">Windows CLI</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/cheatsheets.html#windows" target="_blank">Windows</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/cheatsheets.html#windows_2k" target="_blank">Windows 2k</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/cheatsheets.html#windows_processes" target="_blank">Windows Processes</a></li></ul>';
    }
        ...
        result.innerHTML = 'Publications<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/publications.html#countdown_to_zero_day" target="_blank">Countdown to Zero Day</a></li></ul><br>Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#adopting_zero_trust" target="_blank">Adopting Zero Trust</a></li></ul>';
    }
    else if (input.includes("zeroday") || input.includes("zero day") || input.includes("0day") || input.includes("0 day")) {
    ...
    else if (input.includes("advanced") || input.includes("search") || input.includes("operators")) {
        result.innerHTML = 'Cheat Sheets<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/cheatsheets.html#advanced_search_operators" target="_blank">Advanced Search Operators</a></li></ul>';
    }
    else if (input.includes("jql") || input.includes("jira") || input.includes("query language")) {
        result.innerHTML = 'Cheat Sheets<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/cheatsheets.html#jira_query_language" target="_blank">JIRA Query Language</a></li></ul>';
    }
    else if (input.includes("401") || input.includes("access") || input.includes("denied")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#401_access_denied" target="_blank">401 Access Denied</a></li></ul>';
    }
    else if (input.includes("absolute") || input.includes("appsec")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#absolute_appsec" target="_blank">Absolute AppSec</a></li></ul>';
    }
    else if (input.includes("breach")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#breach" target="_blank">Breach</a></li></ul>';
    }
    else if (input.includes("click") || input.includes("here")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#click_here" target="_blank">Click Here</a></li></ul>';
    }
    else if (input.includes("cybersecurity") || input.includes("today") || input.includes("by") || input.includes("itwc")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#cybersecurity_today_by_itwc" target="_blank">Cybersecurity Today by ITWC</a></li></ul>';
    }
    else if (input.includes("cyberside") || input.includes("chats")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#cyberside_chats" target="_blank">Cyberside Chats</a></li></ul>';
    }
    else if (input.includes("cyberwire") || input.includes("daily")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#cyberwire_daily" target="_blank">CyberWire Daily</a></li></ul>';
    }
    else if (input.includes("defrag") || input.includes("this")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#defrag_this" target="_blank">Defrag This</a></li></ul>';
    }
    else if (input.includes("h4unt3d")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#h4unt3d_hacker" target="_blank">H4unt3d Hacker</a></li></ul>';
    }
    else if (input.includes("hacker")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#h4unt3d_hacker" target="_blank">H4unt3d Hacker</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#the_hacker_chronicles" target="_blank">The Hacker Chronicles</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#hacker_valley_studio" target="_blank">Hacker Valley Studio</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#the_hacker_mind" target="_blank">The Hacker Mind</a></li></ul>';
    }
    else if (input.includes("identity") || input.includes("at") || input.includes("center")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#identity_at_the_center" target="_blank">Identity at the Center</a></li></ul>';
    }
    else if (input.includes("risky") || input.includes("business")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#risky_business" target="_blank">Risky Business</a></li></ul>';
    }
    else if (input.includes("cyberlaw")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#the_cyberlaw" target="_blank">The Cyberlaw</a></li></ul>';
    }
    else if (input.includes("shellsharks")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#the_shellsharks" target="_blank">The Shellsharks</a></li></ul>';
    }
    else if (input.includes("social") || input.includes("engineer")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#the_social-engineer" target="_blank">The Social-Engineer</a></li></ul>';
    }
    else if (input.includes("troy") || input.includes("hunt`s") || input.includes("weekly") || input.includes("update")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#troy_hunt`s_weekly_update" target="_blank">Troy Hunt`s Weekly Update</a></li></ul>';
    }
    else if (input.includes("unsupervised") || input.includes("learning")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#unsupervised_learning" target="_blank">Unsupervised Learning</a></li></ul>';
    }
    else if (input.includes("chris") || input.includes("greer")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#chris_greer" target="_blank">Chris Greer</a></li></ul>';
    }
    else if (input.includes("meisam") || input.includes("eslahi")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#meisam_eslahi" target="_blank">Meisam Eslahi</a></li></ul>';
    }
    else if (input.includes("unfair") || input.includes("fight") || input.includes("blackpoint")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#the_unfair_fight" target="_blank">The Unfair Fight</a></li></ul>';
    }
    else if (input.includes("adventures") || input.includes("alice") || input.includes("bob")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#adventures_of_alice_and_bob" target="_blank">Adventures of Alice and Bob</a></li></ul>';
    }
    else if (input.includes("chronicles")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#the_hacker_chronicles" target="_blank">The Hacker Chronicles</a></li></ul>';
    }
    else if (input.includes("what") || input.includes("shell")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#what_the_shell?" target="_blank">What The Shell?</a></li></ul>';
    }
    else if (input.includes("red") || input.includes("team")) {
        result.innerHTML = 'Publications<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/publications.html#hunting_red_team_activity" target="_blank">Hunting Red Team Activity</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/publications.html#atomic_red_team_hands-on" target="_blank">Atomic Red Team: Hands-On</a></li></ul><br>Training, CTFs & Challenges<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/training.html#red_team_ops" target="_blank">Red Team Ops</a></li></ul>';
    }
    else if (input.includes("six") || input.includes("scenarios") || input.includes("prepare") || input.includes("your") || input.includes("team")) {
        result.innerHTML = 'Publications<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/publications.html#six_scenarios_to_prepare_your_team" target="_blank">Six Scenarios to Prepare Your Team</a></li></ul>';
    }
    else if (input.includes("inversecos")) {
        result.innerHTML = 'Publications<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/publications.html#inversecos" target="_blank">InverseCos</a></li></ul>';
    }
    else if (input.includes("netsec") || input.includes("focus")) {
        result.innerHTML = 'Publications<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/publications.html#netsec_focus" target="_blank">NetSec Focus</a></li></ul>';
    }
    else if (input.includes("filescanio")) {
        result.innerHTML = 'Tooling<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/tooling.html#filescanio" target="_blank">filescan.io</a></li></ul>';
    }
    else if (input.includes("sooty")) {
        result.innerHTML = 'Tooling<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/tooling.html#sooty" target="_blank">Sooty</a></li></ul>';
    }
    else if (input.includes("wtfis")) {
        result.innerHTML = 'Tooling<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/tooling.html#wtfis" target="_blank">wtfis</a></li></ul>';
    }
    else if (input.includes("codepen")) {
        result.innerHTML = 'Tooling<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/tooling.html#codepen" target="_blank">codepen</a></li></ul>';
    }
    else if (input.includes("jsfiddle")) {
        result.innerHTML = 'Tooling<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/tooling.html#jsfiddle" target="_blank">jsfiddle</a></li></ul>';
    }
    else if (input.includes("merlin")) {
        result.innerHTML = 'Tooling<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/tooling.html#merlin" target="_blank">merlin</a></li></ul>';
    }
    else if (input.includes("nrich")) {
        result.innerHTML = 'Tooling<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/tooling.html#nrich" target="_blank">nrich</a></li></ul>';
    }
    else if (input.includes("xnlinkfinder")) {
        result.innerHTML = 'Tooling<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/tooling.html#xnlinkfinder" target="_blank">xnLinkFinder</a></li></ul>';
    }
    else if (input.includes("gtfobins")) {
        result.innerHTML = 'Tooling<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/tooling.html#gtfobins" target="_blank">GTFOBins</a></li></ul>';
    }
    else if (input.includes("appnetlasio") || input.includes("attack aurface")) {
        result.innerHTML = 'Tooling<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/tooling.html#appnetlasio" target="_blank">app.netlas.io</a></li></ul>';
    }
    else if (input.includes("binaryedgeio") || input.includes("codes")) {
        result.innerHTML = 'Tooling<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/tooling.html#binaryedgeio" target="_blank">binaryedge.io</a></li></ul>';
    }
    else if (input.includes("fofainfo") || input.includes("intel")) {
        result.innerHTML = 'Tooling<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/tooling.html#fofainfo" target="_blank">fofa.info</a></li></ul>';
    }
    else if (input.includes("grepapp") || input.includes("wifi")) {
        result.innerHTML = 'Tooling<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/tooling.html#grepapp" target="_blank">grep.app</a></li></ul>';
    }
    else if (input.includes("ivrerocks") || input.includes("servers")) {
        result.innerHTML = 'Tooling<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/tooling.html#ivrerocks" target="_blank">ivre.rocks</a></li></ul>';
    }
    else if (input.includes("leakixnet") || input.includes("intel")) {
        result.innerHTML = 'Tooling<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/tooling.html#leakixnet" target="_blank">leakix.net</a></li></ul>';
    }
    else if (input.includes("myosinttraining")) {
        result.innerHTML = 'Tooling<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/tooling.html#myosinttraining" target="_blank">MyOsint.Training</a></li></ul>';
    }
    else if (input.includes("osintgames")) {
        result.innerHTML = 'Tooling<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/tooling.html#osintgames" target="_blank">OSINT.games</a></li></ul>';
    }
    else if (input.includes("osintme")) {
        result.innerHTML = 'Tooling<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/tooling.html#osintme" target="_blank">osint.me</a></li></ul>';
    }
    else if (input.includes("searchcodecom") || input.includes("codes")) {
        result.innerHTML = 'Tooling<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/tooling.html#searchcodecom" target="_blank">searchcode.com</a></li></ul>';
    }
    else if (input.includes("socradario") || input.includes("intel")) {
        result.innerHTML = 'Tooling<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/tooling.html#socradario" target="_blank">socradar.io</a></li></ul>';
    }
    else if (input.includes("threatool")) {
        result.innerHTML = 'Tooling<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/tooling.html#threatool" target="_blank">Threatool</a></li></ul>';
    }
    else if (input.includes("vulnerscom") || input.includes("vulnerabilities")) {
        result.innerHTML = 'Tooling<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/tooling.html#vulnerscom" target="_blank">vulners.com</a></li></ul>';
    }
    else if (input.includes("netresec")) {
        result.innerHTML = 'Training, CTFs & Challenges<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/training.html#netresec" target="_blank">NetreseC</a></li></ul>';
    }
    else if (input.includes("attackiq") || input.includes("academy")) {
        result.innerHTML = 'Training, CTFs & Challenges<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/training.html#attackiq_academy" target="_blank">AttackIQ Academy</a></li></ul>';
    }
    else if (input.includes("freecodecamp")) {
        result.innerHTML = 'Training, CTFs & Challenges<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/training.html#freecodecamp" target="_blank">freeCodeCamp</a></li></ul>';
    }
    else if (input.includes("h4ck1ng") || input.includes("googl3")) {
        result.innerHTML = 'Training, CTFs & Challenges<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/training.html#h4ck1ng_googl3" target="_blank">H4CK1NG GOOGL3</a></li></ul>';
    }
    else if (input.includes("pentesterlab")) {
        result.innerHTML = 'Training, CTFs & Challenges<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/training.html#pentesterlab" target="_blank">PentesterLab</a></li></ul>';
    }
    else if (input.includes("runcmd")) {
        result.innerHTML = 'Training, CTFs & Challenges<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/training.html#runcmd" target="_blank">RUNCMD</a></li></ul>';
    }
    else if (input.includes("try2hack")) {
        result.innerHTML = 'Training, CTFs & Challenges<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/training.html#try2hack" target="_blank">Try2Hack</a></li></ul>';
    }
    else if (input.includes("vuln") || input.includes("machines")) {
        result.innerHTML = 'Training, CTFs & Challenges<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/training.html#vuln_machines" target="_blank">Vuln Machines</a></li></ul>';
    }
    else if (input.includes("pcap") || input.includes("attack")) {
        result.innerHTML = 'Publications<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/publications.html#using_mitre_attack_threat_hunting_detection" target="_blank">Using MITRE ATT&CK Threat Hunting Detection</a></li></ul><br>Frameworks & Projects<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/projects.html#pcap-attack" target="_blank">PCAP-ATTACK</a></li></ul>';
    }
    else if (input.includes("keyboard") || input.includes("shortcuts")) {
        result.innerHTML = 'Cheat Sheets<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/cheatsheets.html#vscode_macos_keyboard_shortcuts" target="_blank">VScode macOS Keyboard Shortcuts</a></li></ul>';
    }
    else if (input.includes("campaigns")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#how_to_investigate_phishing_campaigns" target="_blank">How to Investigate Phishing Campaigns</a></li></ul>';
    }
    else if (input.includes("brake")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#brakeing_down_security" target="_blank">Brakeing Down Security</a></li></ul>';
    }
    else if (input.includes("defensive")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#defensive_security" target="_blank">Defensive Security</a></li></ul>';
    }
    else if (input.includes("ubuntu")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#ubuntu_security" target="_blank">Ubuntu Security</a></li></ul>';
    }
    else if (input.includes("chicks")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#2_cyber_chicks" target="_blank">2 Cyber Chicks</a></li></ul>';
    }
    else if (input.includes("insights")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#8th_layer_insights" target="_blank">8th Layer Insights</a></li></ul>';
    }
    else if (input.includes("adopting")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#adopting_zero_trust" target="_blank">Adopting Zero Trust</a></li></ul>';
    }
    else if (input.includes("headlines") || input.includes("series")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#cyber_security_headlines_by_the_ciso_series" target="_blank">Cyber Security Headlines by the CISO Series</a></li></ul>';
    }
    else if (input.includes("sauna")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#cyber_security_sauna" target="_blank">Cyber Security Sauna</a></li></ul>';
    }
    else if (input.includes("valley")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#hacker_valley_studio" target="_blank">Hacker Valley Studio</a></li></ul>';
    }
    else if (input.includes("humans")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#hacking_humans" target="_blank">Hacking Humans</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#humans_of_infosec" target="_blank">Humans of InfoSec</a></li></ul>';
    }
    else if (input.includes("naked")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#naked_security" target="_blank">Naked Security</a></li></ul>';
    }
    else if (input.includes("source")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#open_source_security" target="_blank">Open Source Security</a></li></ul>';
    }
    else if (input.includes("purple") || input.includes("squad")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#purple_squad_security" target="_blank">Purple Squad Security</a></li></ul>';
    }
    else if (input.includes("stormcenter")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#sans_internet_stormcenter_daily_cyber" target="_blank">SANS Internet Stormcenter Daily Cyber</a></li></ul>';
    }
    else if (input.includes("task") || input.includes("radio")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#task_force_7_cyber_security_radio" target="_blank">Task Force 7 Cyber Security Radio</a></li></ul>';
    }
    else if (input.includes("443") || input.includes("simplified")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#the_443_security_simplified" target="_blank">The 443 Security Simplified</a></li></ul>';
    }
    else if (input.includes("tap") || input.includes("cybertap")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#the_cyber_tap_(cybertap)" target="_blank">The Cyber Tap (cyberTAP)</a></li></ul>';
    }
    else if (input.includes("developer")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#the_secure_developer" target="_blank">The Secure Developer</a></li></ul>';
    }
    else if (input.includes("shared") || input.includes("show")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#the_shared_security_show" target="_blank">The Shared Security Show</a></li></ul>';
    }
    else if (input.includes("virtual") || input.includes("moment")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#the_virtual_ciso_moment" target="_blank">The Virtual CISO Moment</a></li></ul>';
    }
    else if (input.includes("talk") || input.includes("monica")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#we_talk_cyber_(monica_talks_cyber)" target="_blank">We Talk Cyber (Monica Talks Cyber)</a></li></ul>';
    }
    else if (input.includes("helle")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#joe_helle" target="_blank">Joe Helle</a></li></ul>';
    }
    else if (input.includes("minute")) {
        result.innerHTML = 'Media &amp; Socials<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/media.html#7_minute_security" target="_blank">7 Minute Security</a></li></ul>';
    }
    else if (input.includes("python")) {
        result.innerHTML = 'Publications<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/publications.html#python_red_team_pentest_threat_hunt" target="_blank">Python Red Team Pentest Threat Hunt</a></li></ul><br>Tooling<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/tooling.html#python_tools" target="_blank">Python Tools</a></li></ul>';
    }
    else if (input.includes("detection")) {
        result.innerHTML = 'Publications<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/publications.html#using_mitre_attack_threat_hunting_detection" target="_blank">Using MITRE ATT&CK Threat Hunting Detection</a></li></ul>';
    }
    else if (input.includes("golang")) {
        result.innerHTML = 'Publications<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/publications.html#analysis_of_golang_malware" target="_blank">Analysis of GoLang Malware</a></li></ul>';
    }
    else if (input.includes("blue") || input.includes("team") || input.includes("system") || input.includes("live")) {
        result.innerHTML = 'Publications<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/publications.html#blue_team-system_live_analysis" target="_blank">Blue Team-System Live Analysis</a></li></ul>';
    }
    else if (input.includes("wannacry")) {
        result.innerHTML = 'Publications<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/publications.html#reverse_engineering_wannacry" target="_blank">Reverse Engineering Wannacry</a></li></ul>';
    }
    else if (input.includes("wmi")) {
        result.innerHTML = 'Publications<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/publications.html#wmic_for_incident_response" target="_blank">WMIC for Incident Response</a></li></ul>';
    }
    else if (input.includes("art")) {
        result.innerHTML = 'Publications<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/publications.html#the_art_of_mac_malware" target="_blank">The Art of Mac Malware</a></li></ul>';
    }
    else if (input.includes("capabilities") || input.includes("national")) {
        result.innerHTML = 'Publications<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/publications.html#cyber_capabilities_and_national_power" target="_blank">Cyber Capabilities and National Power</a></li></ul>';
    }
    else if (input.includes("elite") || input.includes("fsb")) {
        result.innerHTML = 'Publications<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/publications.html#elite_hackers_of_the_fsb" target="_blank">Elite Hackers of the FSB</a></li></ul>';
    }
    else if (input.includes("amateur")) {
        result.innerHTML = 'Publications<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/publications.html#infosec_amateur" target="_blank">InfoSec Amateur</a></li></ul>';
    }
    else if (input.includes("awareness") || input.includes("planning") || input.includes("kit")) {
        result.innerHTML = 'Tooling<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/tooling.html#ssa_security_awareness_planning_kit" target="_blank">SSA Security Awareness Planning Kit</a></li></ul>';
    }
    else if (input.includes("architecture")) {
        result.innerHTML = 'Tooling<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/tooling.html#google_cloud_architecture_diagramming" target="_blank">Google Cloud Architecture Diagramming</a></li></ul>';
    }
    else if (input.includes("mail") || input.includes("temp")) {
        result.innerHTML = 'Tooling<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/tooling.html#10minutemail" target="_blank">10minutemail</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/tooling.html#guerrilla_mail" target="_blank">Guerrilla Mail</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/tooling.html#lavabit" target="_blank">Lavabit</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/tooling.html#maildrop" target="_blank">maildrop</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/tooling.html#proton_mail" target="_blank">Proton Mail</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/tooling.html#riseup" target="_blank">riseup</a></li><li><a href="https://oscybershop.herokuapp.com/main/pages/tooling.html#tutanota" target="_blank">Tutanota</a></li></ul>';
    }
    else if (input.includes("class")) {
        result.innerHTML = 'Training, CTFs & Challenges<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/training.html#sam`s_class" target="_blank">Sam`s Class</a></li></ul>';
    }
    else if (input.includes("enginuity")) {
        result.innerHTML = 'Training, CTFs & Challenges<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/training.html#mitre_enginuity" target="_blank">MITRE Enginuity</a></li></ul>';
    }
    else if (input.includes("certified")) {
        result.innerHTML = 'Training, CTFs & Challenges<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/training.html#certified_secure" target="_blank">Certified Secure</a></li></ul>';
    }
    else if (input.includes("echo")) {
        result.innerHTML = 'Training, CTFs & Challenges<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/training.html#echoctf" target="_blank">EchoCTF</a></li></ul>';
    }
    else if (input.includes("portswigger") || input.includes("academy")) {
        result.innerHTML = 'Training, CTFs & Challenges<ul><li><a href="https://oscybershop.herokuapp.com/main/pages/training.html#portswigger_web_security_academy" target="_blank">PortSwigger Web Security Academy</a></li></ul>';
    }
    else {
        result.innerHTML = "";
    }
